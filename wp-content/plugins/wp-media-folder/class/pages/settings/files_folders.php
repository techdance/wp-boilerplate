    ...
    <div class="content-box content-wpmf-files-folders">
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Tag available: {sitename} - {foldername} - {date} - {original name} - {timestamp} .
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                <label for="wpmf_patern" class="ju-setting-label text"
                       data-tippy="<?php esc_html_e('Tag avaiable: {sitename} - {foldername} - {date} - {original name} .
        ...
        <h4 class="title_h4">
            <label data-tippy="<?php esc_html_e('Remove characters automatically on media upload', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf-no-shadow">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Additionally to the file rename on upload pattern, you can apply rename options below', 'wpmf') ?>"
        ...
        <div class="ju-settings-option wpmf_width_100 p-lr-20 wpmf-no-shadow">
            <div class="wpmf_row_full">
                <h2>
                    <label data-tippy="<?php esc_html_e('Add capital letters automatically on media upload', 'wpmf'); ?>"
...
<div id="watermark" class="tab-content">
    <div class="content-box content-wpmf-files-folders">
        <div class="ju-settings-option wpmf_width_100 p-lr-20">
            <div class="ju-settings-option wpmf_width_40 wpmf-no-shadow wpmf-no-padding wpmf-no-margin">
                <div class="wpmf_row_full">
                    ...
                    <b data-tippy="<?php esc_html_e('Watermark will be applied only after saving the
            ...
            <div class="ju-settings-option wpmf_width_100 wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <label data-tippy="<?php esc_html_e('Select a picture that will be applied over your images', 'wpmf') ?>"
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <label data-tippy="<?php esc_html_e('Set the watermark opacity (0-100)', 'wpmf'); ?>" class="p-b-20 wpmf_left text label_text">
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <label data-tippy="<?php esc_html_e('Select the watermark image position', 'wpmf'); ?>" class="p-b-20 wpmf_left text label_text">
            ...
            <div class="ju-settings-option wpmf-no-shadow wpmf-no-padding">
                <div class="wpmf_row_full">
                    <label data-tippy="<?php esc_html_e('Make a watermark fit each photo size, resize the width of the watermark', 'wpmf'); ?>"
                        class="p-b-20 wpmf_left text label_text">
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <label data-tippy="<?php esc_html_e('Select the watermark margin unit', 'wpmf'); ?>" class="p-b-20 wpmf_left text label_text">
            ...
            <div class="ju-settings-option wpmf_width_100 wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <label data-tippy="<?php esc_html_e('Watermark image margin', 'wpmf'); ?>" class="p-b-20 wpmf_left text label_text">
        ...
        <div class="ju-settings-option wpmf_width_100 p-lr-20">
            <div class="ju-settings-option wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <h4 data-tippy="<?php esc_html_e('Select the size where you want to apply the watermark', 'wpmf'); ?>"
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <div class="wpmf_row_full">
                    <h4 data-tippy="<?php esc_html_e('Exclude Folders', 'wpmf'); ?>"
