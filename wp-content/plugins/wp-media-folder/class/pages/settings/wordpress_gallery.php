        ...
        <div class="content-wpmf-gallery">
            <div class="ju-settings-option">
                <div class="wpmf_row_full">
                    ...
                    <label data-tippy="<?php esc_html_e('Enhance the WordPress default gallery system
            ...
            <div class="ju-settings-option wpmf_right m-r-0">
                <div class="wpmf_row_full">
                    ...
                    <label data-tippy="<?php esc_html_e('Add a lightbox option on each image of your WordPress content', 'wpmf'); ?>"
            ...
            <div class="ju-settings-option">
                <div class="wpmf_row_full">
                    ...
                    <label data-tippy="<?php esc_html_e('Add lightbox to images in WordPress default  galleries', 'wpmf'); ?>"
                           class="ju-setting-label text">
            ...
            <div class="ju-settings-option wpmf_right m-r-0">
                <div class="wpmf_row_full">
                    ...
                    <label data-tippy="<?php esc_html_e('Use caption of images on lightbox instead title', 'wpmf'); ?>"
                           class="ju-setting-label text">
...
<div id="wp_gallery_shortcode" class="tab-content">
    <div class="content-box">
        <div class="wp_gallery_shortcode_settings_wrap">
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <label class="wpmf_width_100 p-b-20 wpmf_left text label_text" data-tippy="<?php esc_html_e('Number of columns
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <label class="wpmf_width_100 p-b-20 wpmf_left text label_text" data-tippy="<?php esc_html_e('Image size to load
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <label class="wpmf_width_100 p-b-20 wpmf_left text label_text" data-tippy="<?php esc_html_e('Image size to load by default as full
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <label class="wpmf_width_100 p-b-20 wpmf_left text label_text" data-tippy="<?php esc_html_e('Action when the user
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <label class="wpmf_width_100 p-b-20 wpmf_left text label_text" data-tippy="<?php esc_html_e('Image gallery
            ...
            <div class="ju-settings-option wpmf-no-shadow">
                <label class="wpmf_width_100 p-b-20 wpmf_left text label_text" data-tippy="<?php esc_html_e('By default, use ascending
            ...
            <div class="wpmf_width_100 m-t-30">
                <div class="wpmf_row_full" style="margin: 0 0 10px 0; position: relative;">
                    ...
                    <div class="wpmf_copy_shortcode" data-input="wp_gallery_shortcode_input" style="margin: 0">
                        <i data-tippy="<?php esc_html_e('Copy shortcode', 'wpmf'); ?>"
