    ...
    <div class="content-box content-wpmf-general">
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Load WP Media Folder files on frontend. Activate it if
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Display and copy the folder ID by making a right click on the folder', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Load a left folder tree on the left part of the media manager for a faster folder navigation', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Enable or not the display of folders in the main view on top of the media', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Display the number of media
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Possibility to replace an existing file by another one.', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Add a button to duplicate a media from the media manager', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('On mouse hover on an image, a large preview is displayed', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Additional filters will be added in the media views.', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Automatically play the GIF animation on page load. By default it’s a static image in WordPress', 'wpmf') ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('When you remove a folder all media inside will also be
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('If enabled, when you search file in a folder, it will search in its subfolders too', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Delete all data on uninstall (including addons)', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Remote video feature: include and manage remote video from Youtube Vimeo or Dailymotion', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-tippy="<?php esc_html_e('Right click on an image or file in the media manager to download it. Image original sized will be downloaded', 'wpmf'); ?>"
